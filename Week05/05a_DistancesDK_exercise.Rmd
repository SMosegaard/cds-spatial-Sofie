...
# Create spatial data matrix for Aarhus and Sydney
...
= the Great Circle distance is 25.800 meters smaller than the Meeus distance
...
(16174776-16148979)/1000 # difference = 25.797 km

# Vincenty ellipsoid distance is the shortest

# Calculate percent difference
(16174776-16148979)/16148979*100 # 0.16%
...
# Save the viking dataset for another time

monuments <- read_sf("../anlaeg_all_25832.shp")

# Filter Viking-era finds
viking_aarhus <- monuments %>% 
  filter(datering == "Vikingetid")

saveRDS(viking, "/Users/Administrator/Documents/Semester6/Spatial/cds-spatial_Sofie/Week05/viking2.rds")
...
viking_aarhus <- readRDS("viking2.rds")
...
# create buffer
nb_buf <- st_buffer(nobel, dist = 10000)
